...
public class TrabajoFinalLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"LETRA", "DIGITO", "WS", "PA", "PC", "LLA", "LLC", "CORA", "CORC", "PYC", 
			"IGUAL", "COMA", "PUNTO", "IGUALIGUAL", "MENOR", "MAYOR", "MENIG", "MAYIG", 
			"DIF", "MAS", "MENOS", "MULT", "DIV", "INCREMENTO", "DECREMENTO", "INT", 
			"FLOAT", "DOUBLE", "STRING", "IF", "ELSE", "FOR", "WHILE", "BREAK", "RETURN", 
	...
	public TrabajoFinalLexer(CharStream input) {
		super(input);
